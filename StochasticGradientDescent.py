...
test_loader = DataLoader(test_dataset, batch_size=1, shuffle=True)  # 使用 batch_size=1 来实现 SGD
...
if __name__ == "__main__":
    model = StochasticGradientDescentLogisticRegression(alpha=1e-3, epoch=20)  # 调整学习率
